...
pub fn report_command(gd: &GameData,) {
    ...
    println!("hungry: {}", gd.people.hungry);
    println!("starving: {}", gd.people.starving);
    println!("thirsty: {}", gd.people.thirsty);
    println!("dehydrated: {}", gd.people.dehydrated);
    // if people.hungry == true {
    //     println!("hungry: {}", people.hungry);
    // }
    // else if people.starving == true {
    //     println!("starving: {}", people.starving);
    // } else {
    //     print
    // }

    // if people.thirsty == true {
    //     println!("thirsty: {}", people.thirsty);
    // }
    // else if people.dehydrated == true {
    //     println!("dehydrated: {}", people.dehydrated);
    // }
}
